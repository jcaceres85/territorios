    	...
    	jsPanel.create({
            id: 'panelCapas' + geovisor_extra_id,
	          ...
	          content:     function (panel) {
	              $(this.content).load('ctrl/lista_capas.php?geovisor_id=' + geovisor_extra_id + '&access_token=<?php echo $access_token; ?>', function () {
	              });
	          },
	          onwindowresize: true
	       });
    ...
    <script>
        ...
        jsPanel.create({
            id: 'panelCapas',
	          ...
	          animateIn:   'jsPanelFadeIn',
	          headerTitle: '<i class="map marker icon"></i> Panel de capas',
	          headerControls: {
	              close: 'remove',
                maximize: 'remove',
	          },
	          ...
	          content:     function (panel) {
	              $(this.content).load('ctrl/lista_capas.php?geovisor_id=<?php echo $geovisor_id . "&access_token=". $access_token; ?>', function () {
